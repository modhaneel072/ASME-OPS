...
describe('Profile section', () => {
  it('shows the session identity, permission summary, portal link and log out', async () => {
    ...
    expect(screen.getByRole('link', { name: 'Edit profile in the member portal' })).toHaveAttribute('href', '/portal/member/profile')
